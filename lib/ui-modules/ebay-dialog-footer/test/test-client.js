...
// These tests come from eBayUI and use the marko CLI `marko test`
const test = function () {return it.apply(global, arguments);} 

describe.skip('given the dialog is in the default state', () => {
    let widget;
    let root;
    let dialogWindow;
    let close;
