module.exports = require('marko-widgets').defineComponent({
    ...
    handleClose: function() {
        ...
        this.setState('modalBasicBoxed', false);

        this.setState('modalFull', false);
        this.setState('modalFlexibleBoxed', false);
    ...
    openEbayDialogBasicBoxed: function() {
        this.setState('modalBasicBoxed', true);
    },
    ...
    openEbayDialogFlexibleBoxed: function() {
        this.setState('modalFlexibleBoxed', true);
    },
